...
function ActualityComponent() {
  return (
    <div className='z-0 m-0 md:flex block items-center justify-center bg-white w-screen md:h-screen h-auto mt-20 md:mt-0'>
      <div className='max-w-screen-2xl w-full h-auto py-8 px-4'>
        <div className='h-auto lg:w-1/2 flex-col gap-4'>
          ...
          <h1 className='font-medium md:text-[18px] text-[15px] text-[#D3D63F] mb-8'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui quos autem repellendus impedit, aliquid temporibus! Voluptatibus beatae aut ab earum nesciunt, mollitia architecto similique, nemo dolorum eum vero fuga cum?</h1>
        </div>
        <div className='flex flex-wrap justify-between items-center w-full h-auto md:p-4 gap-2'>
          <ActualityBox
